...
function setupSidebar() {
    ...
    if ($('#sidebar').length) {
        ...
        if (debug) {
            console.log('Sidebar setup called but sidebar exists, ignoring.');
        }
        // Flag sidebar as loaded for giggles.
        sidebarLoaded = true;
    } else {
        if (debug) {
            console.log('Sidebar setup called, setting up sidebar.');
        }
        ...
        if (debug) {
            console.log('Sidebar found ' + length + ' vehicle types.');
        }
        for (index = 0; index < length; ++index) {
            if (debug) {
                console.log('Adding vehicle icon to sidebar header: ' + vehicleTypes[index].protocol);
            }
        ...
        for (index = 0; index < length; ++index) {
            if (debug) {
                console.log('Adding vehicle table to sidebar body: ' + vehicleTypes[index].protocol);
            }
