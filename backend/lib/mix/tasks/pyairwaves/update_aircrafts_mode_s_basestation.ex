defmodule Mix.Tasks.Pyairwaves.UpdateAircraftsModeSbasestaion do
  use Mix.Task
  ...
  @moduledoc """
  DEPRECATED Update the list of aircrafts Mode S and Aircraft Owners
  ...
  @shortdoc "DEPRECATED Update the list of Aircraft Mode S and Aircraft Owners"
  def run(_) do
